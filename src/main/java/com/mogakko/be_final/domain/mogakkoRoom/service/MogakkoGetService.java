...
public class MogakkoGetService {
    ...
    private final MogakkoRoomCustomRepositoryImpl mogakkoRoomCustomRepositoryImpl;

    // 인기 지역 모각코 조회
    @Transactional(readOnly = true)
    public ResponseEntity<Message> topMogakko() {
        List<NeighborhoodResponseDto> mogakkoRoomList = mogakkoRoomCustomRepositoryImpl.findTop4NeighborhoodsOrderByCountDesc();
